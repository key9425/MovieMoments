            ...
            <form @submit.prevent="saveGroupMovie">
              ...
              <div class="mb-4">
                ...
                <div class="search-area">
                  <div class="position-relative">
                    <input type="text" class="form-control" v-model="searchKeyword" placeholder="영화 제목을 입력하세요" :class="{ 'is-searching': isSearching }" />
                ...
                <div v-if="searchResults.length" class="search-results mb-3">
                  <div v-for="movie in searchResults" :key="movie.id" class="movie-item" :class="{ selected: selectedMovie?.id === movie.id }" @click="selectMovie(movie)">
              ...
              <div v-if="selectedMovie" class="selected-movie mb-4">
                ...
                <div class="d-flex align-items-center gap-3 p-3 bg-light rounded">
                  <img :src="`https://image.tmdb.org/t/p/w92${selectedMovie.poster_path}`" :alt="selectedMovie.title" class="rounded" width="60" />
                  <div>
              ...
              <div class="mb-4">
                ...
                <input type="date" class="form-control" id="watchedDate" v-model="watchedDate" required />
              </div>

              <!-- 제출 버튼 -->
              <div class="d-grid">
                <button type="submit" class="btn btn-primary" :disabled="!selectedMovie || !watchedDate || isSaving">
